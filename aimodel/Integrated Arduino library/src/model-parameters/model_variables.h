...
const char* ei_classifier_inferencing_categories[] = { "on_the_air", "on_the_ground", "playing" };
...
const ei_config_tflite_eon_graph_t ei_config_graph_4 = {
...
const uint8_t ei_output_tensors_indices_4[1] = { 0 };
const uint8_t ei_output_tensors_size_4 = 1;
ei_learning_block_config_tflite_graph_t ei_learning_block_config_4 = {
    .implementation_version = 1,
    .block_id = 4,
    .output_tensors_indices = ei_output_tensors_indices_4,
    .output_tensors_size = ei_output_tensors_size_4,
    .quantized = 1,
    .compiled = 1,
    .graph_config = (void*)&ei_config_graph_4,
    .dequantize_output = 0,
};
...
ei_fill_result_classification_i8_config_t ei_fill_result_classification_i8_config_4 = {
    .zero_point = -128,
    .scale = 0.00390625
};
...
const ei_postprocessing_block_t ei_postprocessing_blocks[ei_postprocessing_blocks_size] = {
    {
        ...
        .display_fn = NULL,
        .config = (void*)&ei_fill_result_classification_i8_config_4,
        .input_block_id = 4
    },
};

const ei_impulse_t impulse_763708_0 = {
    .project_id = 763708,
    .project_owner = "CFY2417",
    .project_name = "mpu",
    .impulse_id = 1,
    ...
    .raw_sample_count = 270,
    .raw_samples_per_frame = 3,
    .dsp_input_frame_size = 270 * 3,
    .input_width = 0,
    .input_height = 0,
    .input_frames = 0,
    .interval_ms = 111.11111111111111,
    .frequency = 9,
    ...
    .fusion_string = "gyroX + gyroY + gyroZ",
    .slice_size = (270/4),
...
ei_impulse_handle_t impulse_handle_763708_0 = ei_impulse_handle_t( &impulse_763708_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_763708_0;
